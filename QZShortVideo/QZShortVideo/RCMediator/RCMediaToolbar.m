...
- (void)rc_initSubviews
{
    ...
    [_closeBtn setImage:[UIImage imageNamed:@"hVideo_back"] forState:UIControlStateNormal];
    ...
    _cancelBtn.frame = CGRectMake(x, y, w+20, w+20);
...
//    _cancelBtn.layer.borderWidth = 1.0;
    ...
    [_cancelBtn setImage:[UIImage imageNamed:@"ic_sc"] forState:UIControlStateNormal];
    ...
    _doneBtn.frame = CGRectMake(x, y, w+20, w+20);
...
//    [_doneBtn setTitle:@"done" forState:UIControlStateNormal];
    [_doneBtn setImage:[UIImage imageNamed:@"ic_xz"] forState:UIControlStateNormal];
